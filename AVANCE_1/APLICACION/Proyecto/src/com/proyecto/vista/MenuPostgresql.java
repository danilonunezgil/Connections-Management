...
import com.proyecto.controlador.ControladorPostgresql;
...
public class MenuPostgresql {
  
    private final ControladorPostgresql controlador = new ControladorPostgresql();
    private static final Scanner leer = new Scanner(System.in);
    private static final MenuPrincipal start = new MenuPrincipal();
    ...
    public void menuActualizarAmigo(AmigoVO amigoVO){
        ...
        try {
            ...
            switch (opc) {
                ...
                case 2:
                    ...
                    AmigoVO amigo = controlador.ingresarAmigo();
