...
public class AmigoBO {
    ...
    public List<AmigoVO> listar(Connection connection){
        
        ArrayList<AmigoVO> listadoAmigos = new ArrayList<>();
    ...
    public AmigoVO insertar(Connection connection){
        AmigoVO amigo = generarRandom();
    ...
    public AmigoVO generarRandom(){
        ...
        AmigoVO amigo = new AmigoVO(nombresRand[(int) (Math.random() * 10)], apellidosRand[(int) (Math.random() * 10)], telefonos[(int) (Math.random() * 10)], direcciones[(int) (Math.random() * 10)], correos[(int) (Math.random() * 10)]);

        return amigo;
    }

    public AmigoVO buscarId(Connection connection,Number idAmigo) {
    ...
    public AmigoVO actualizar(Connection connection,AmigoVO amigoVO) {
